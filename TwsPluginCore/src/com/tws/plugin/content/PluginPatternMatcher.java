...
public class PluginPatternMatcher implements Serializable {
	 ...
	 * can use the '*' character to match against zero or more occurrences of
	 * the character immediately before. If the character before it is '.' it
	 * will match any character. The character '\' can be used as an escape.
	 * This essentially provides only the '*' wildcard part of a normal regexp.
	 */
