...
public class PluginManifestParser {
			...
			do {
				...
				case XmlPullParser.START_TAG: {
					...
					if ("manifest".equals(tag)) {
						...
						TwsLog.d(TAG, "packageName=" + packageName + " versionCode=" + versionCode + " versionName=" + versionName + " sharedUserId="
								+ sharedUserId);
						...
						TwsLog.d(TAG, "applicationName=" + applicationName + " Description=" + desciptor.getDescription());
	...
	private static String addIntentFilter(HashMap<String, ArrayList<PluginIntentFilter>> map, String packageName, String namespace, XmlPullParser parser,
