...
public class CompatForContentProvider {
	...
	public static Bundle call(Uri uri, String method, String arg, Bundle extras) {
		...
		if (Build.VERSION.SDK_INT >= 11) {
			...
			try {
				Object mContentProvider = RefInvoker.getFieldObject(client, ContentProviderClient.class,
						"mContentProvider");
				if (mContentProvider != null) {
					// public Bundle call(String method, String request, Bundle
					// args)
					Object result = RefInvoker.invokeMethod(mContentProvider, "android.content.IContentProvider",
							"call", new Class[] { String.class, String.class, Bundle.class }, new Object[] { method,
									arg, extras });
