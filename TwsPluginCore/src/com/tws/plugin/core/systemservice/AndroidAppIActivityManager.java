...
public class AndroidAppIActivityManager extends MethodProxy {
	...
	public static void installProxy() {
		...
		Object androidAppActivityManagerProxy = RefInvoker.invokeStaticMethod("android.app.ActivityManagerNative", "getDefault", (Class[]) null,
				(Object[]) null);
	...
	public static class killBackgroundProcesses extends MethodDelegate {
		...
		public Object beforeInvoke(Object target, Method method, Object[] args) {
			TwsLog.e(TAG, "killBackgroundProcesses beforeInvoke method:" + method.getName());
			// TODO 需要时再说
	...
	public static class getServices extends MethodDelegate {
		@Override
		public Object beforeInvoke(Object target, Method method, Object[] args) {
			TwsLog.e(TAG, "getServices beforeInvoke method=" + method.getName());
			// TODO 需要时再说
			return super.beforeInvoke(target, method, args);
		}
	}
