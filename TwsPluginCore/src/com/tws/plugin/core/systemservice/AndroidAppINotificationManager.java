...
public class AndroidAppINotificationManager extends MethodProxy {
	...
	public static void installProxy() {
		...
		Object androidAppINotificationStubProxy = RefInvoker.invokeStaticMethod(NotificationManager.class.getName(), "getService", (Class[]) null,
				(Object[]) null);
			...
			if (layoutId != 0) {
				...
				if (!ResourceUtil.isMainResId(layoutId)) {
					...
					if (notification.contentIntent != null) {
						Intent intent = (Intent) RefInvoker.invokeMethod(notification.contentIntent, PendingIntent.class.getName(), "getIntent",
						...
						if (intent.getAction() != null && intent.getAction().contains(PluginIntentResolver.CLASS_SEPARATOR)) {
							...
							if (pd != null) {
								...
								newInfo.publicSourceDir = getNotificationResourcePath(pd.getInstalledPath(), PluginLoader.getApplication()
