...
public class ServiceBinderBridge {
	...
	public static Object queryService(final String serviceName, String iFaceClassName) {
		try {
			...
			return Proxy.newProxyInstance(cl, new Class[] { clientClass }, new InvocationHandler() {

				@Override
				public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {

					Bundle bundle = CompatForContentProvider.call(LocalServiceBinder.buildUri(), serviceName,
							method.toGenericString(), wrapperParams(args));
	...
	static void putToBundle(Bundle bundle, String key, Object value) {
		if (Build.VERSION.SDK_INT < 19) {
			...
			Map<String, Object> mMap = (Map<String, Object>) RefInvoker.getFieldObject(bundle, android.os.Bundle.class,
					"mMap");
			mMap.put(key, value);
			...
			RefInvoker.invokeMethod(bundle, android.os.Bundle.class, "unparcel", (Class[]) null, (Object[]) null);
			ArrayMap<String, Object> mMap = (ArrayMap<String, Object>) RefInvoker.getFieldObject(bundle,
					android.os.Bundle.class, "mMap");
			mMap.put(key, value);
			...
			ArrayMap<String, Object> mMap = (ArrayMap<String, Object>) RefInvoker.getFieldObject(bundle,
					android.os.BaseBundle.class, "mMap");
			mMap.put(key, value);
