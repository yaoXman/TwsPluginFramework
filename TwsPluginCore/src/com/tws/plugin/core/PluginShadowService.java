...
public class PluginShadowService extends Service {
	...
	private void callServiceOnCreate() {
		...
		try {
			RefInvoker.invokeMethod(mBaseContext, "android.app.ContextImpl", "setOuterContext", new Class[] { Context.class }, new Object[] { realService });
			RefInvoker.invokeMethod(realService, Service.class, "attach", new Class[] { Context.class, ActivityThread.clazz(), String.class, IBinder.class,
					Application.class, Object.class }, new Object[] { mBaseContext, mThread, mClassName, mToken, mApplication, mActivityManager });
