...
public class PluginViewCreator implements LayoutInflater.Factory {
	...
	private View createView(Context Context, String pluginId, String viewClassName, AttributeSet atts) throws ClassNotFoundException, InflateException {
		try {
			...
			if (pluginDescriptor != null) {
				...
				Context pluginViewContext = PluginLoader
						.getNewPluginComponentContext(plugin.pluginContext, baseContext, pluginDescriptor.getApplicationTheme());
				Class<? extends View> clazz = pluginViewContext.getClassLoader().loadClass(viewClassName).asSubclass(View.class);
